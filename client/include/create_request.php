<?php
    ...
    $sql = "INSERT INTO requests (useridfk, request_status, title, from_place, to_place, from_time, to_time, note, attachments, created)
    VALUES ('$userid', '1', '$title', '$from_place', '$to_place', '$from_formatted', '$to_formatted', '$note', '$attach', '$created')";
